...
public class Assignment7Q3 {
    ...
    public static void main(String[] args) {
        ...
        Trader trader1 = new Trader("Ayush","Pune");
        Trader trader2 = new Trader("Rex","Bangalore");
        Trader trader3 = new Trader("Athrv","Pune");
        Trader trader4 = new Trader("Paaji","Pune");
        Trader trader5 = new Trader("Shraddha","Indore");
        Trader trader6 = new Trader("Akanksha","Indore");
